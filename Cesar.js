...
import { SetClaireTextAction, SetKeyAction, ResetAction,
    CryptCesarTextAction, DecryptCesarTextAction } from './Redux/Cesar/Actions';
import BodyCesarCipher from './Components/BodyCipher';

class Cesar extends Component { /* ({route, navigation}) => {*/
    constructor (props) {
        super(props);
        this.state = {
            text: '',
    ...
    render() {
        ...
        const numberInputHandler = input => {
            ...
            this.setState({decalage: input.replace(/[^0-9]/g, '')});
        ...
        return (
            <View style={styles.maincontainer}> 
                ...
                show={true} detail={false} keyboardType='decimal-pad' maxLength={2}
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        crypt_text:(params) => {dispatch(CryptCesarTextAction(params))},
        decrypt_text:(params) => {dispatch(DecryptCesarTextAction(params))},
...
export default connect(mapStateToProps, mapDispatchToProps)(Cesar);
